...
export default function Layout() {
    ...
    const currentAppName = "Epigraf";

    return (
        <div className={`min-h-screen bg-background flex flex-col md:flex-row font-sans selection:bg-primary/20 selection:text-primary overflow-hidden transition-colors duration-700 theme-${settings.theme}`}>
            ...
            <TooltipProvider delayDuration={0}>
                ...
                >
                    ...
                    <div className="p-4 space-y-4 overflow-hidden">
                        ...
                        {/* Professional Theme Selection Menu */}
                        <DropdownMenu>
                            <Tooltip>
                                <TooltipTrigger asChild>
            ...
            <main className="flex-1 overflow-auto h-screen relative bg-background/50 transition-colors duration-700">
                ...
                <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none -z-10 opacity-30">
                    <div
                        className="absolute -top-[20%] -left-[10%] w-[70%] h-[70%] rounded-full blur-[120px] bg-primary/20 animate-pulse duration-[10000ms]"
                    />
                    <div
                        className="absolute -bottom-[20%] -right-[10%] w-[60%] h-[60%] rounded-full blur-[100px] bg-primary/10 animate-pulse duration-[8000ms]"
                    />
                </div>
